...
- **Вопросы:** "профиль собран, поправить или продолжаем к шаблону?"; затем "шаблон открыт в браузере, ОК или правки?".
...
- Не делай `git init` в `~/seo-projects/` - это родительский namespace, не репо.
