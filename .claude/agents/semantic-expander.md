...
- **Исключить: страницы с `commerce_note == "info_dominant"`** - выдача нерелевантная, расширять смысла нет. marker-finder уже принял решение САМ (роль -> umbrella, инфо-запрос -> блог, см. decisions.json), клиента не спрашиваем. Это страховка от слива JM-лимитов.
