...
const MANIFEST = {
  ...
  legal: {
    company: "ООО ВентПро",
    // ИНН фикстуры обязан проходить контрольную цифру (verify-prototype проверяет формат
    // реквизита): вымышленное «круглое» число заваливало проверку и красило набор.
    inn: "1655000003",
    ogrn: "1021600000000",
