...
const SERVICE_NAMES = {
  ...
  RP: "SEO-отчетность и стратегическое сопровождение",
};
...
const SERVICE_DESCRIPTIONS = {
  PA: "Бриф, конкуренты, SERP-вердикт, скан смыслов лидеров, отчет A2",
  ...
  PFP: "Усиленный ПФ для высокой конкуренции (увеличенный объем запросов)",
  ...
  RP: "Еженедельный + ежемесячный отчет с корректировкой стратегии",
};

const SERVICE_RESULTS = {
  PA: "Отчет A2: вердикт, конкуренты, точки роста, сравнение с лидерами, стоп-лист",
