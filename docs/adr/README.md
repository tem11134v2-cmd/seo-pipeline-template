...
| [025](025-final-verifiers.md) | Финальный гейт в каждом клиентском скиле: механический `verify-*.mjs` + opus-верификатор (не чинит, ре-делегация лимит 2, отдельный state `*-verified`) | Принято |
| [026](026-article-pipeline-scaling.md) | Масштабирование `/seo-statya`: агент photo-producer, серийная очередь `batch-queue`, распил SKILL/REFERENCE, диета возвратов | Принято |
